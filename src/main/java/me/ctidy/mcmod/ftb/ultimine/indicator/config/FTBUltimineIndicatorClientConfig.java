...
public interface FTBUltimineIndicatorClientConfig {
    ...
    BooleanValue SHOW_CHANGE_SHAPE_HINT = GROUP_ULTIMINE_STATUS
            .addBoolean("show_change_shape_hint", false)
            .withDisplayOrder(1)
            .comment("Whether to display the hint text about scrolling to change shape");
